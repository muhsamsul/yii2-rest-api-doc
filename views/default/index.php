            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#<?= str_replace('/','-',$entity['title']); ?>">
                            <?= $entity['title'] ?>
                        </a>
                    </h4>
                </div>
                <div id="<?= str_replace('/','-',$entity['title']); ?>" class="panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">

                        <div class="list-group" id="<?= str_replace('/','-',$entity['title']); ?>-list" role="tablist" aria-multiselectable="true">
                            <?php foreach ($entity['rules'] as $ri => $rule) : ?>
                                <a class="endpoint-toggle list-group-item" role="button" data-parent="#<?= str_replace('/','-',$entity['title']); ?>-list" data-toggle="collapse" href="#rule-<?= $ei ?>-<?= $ri ?>" aria-expanded="false" aria-controls="rule-<?= $ei ?>-<?= $ri ?>">
                                    <div class="row">
                                        <div class="col-lg-12">
